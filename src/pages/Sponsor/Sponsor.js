      ...
      <div className='page-layout'>
        ...
        <div className='transparent-block'>
          <div className='transparent-block-container'>
            <div className='transparent-block-title'>Interested in sponsoring Loco Moco Security Conference?</div>
            <div className='transparent-block-text'>We understand your products and services play an important part in the cyber security landscape and we cannot put this conference on without your help.  Get your name and product in front of hundreds of security professionals and decision makes by sponsoring Loco Moco Security Conference! While we do appreciate our sponsors, please understand that Loco Moco is first and foremost for our attendees so we can only accept sponsors who have their best interests in mind.</div>
          </div>
